...
class PlaneTestCase(TestCase):
    def setUp(self):
        ...
        plane1 = Plane.objects.create(author=author1, content='I am so sad', is_replied=False, is_reported=False,
                                      latitude=37.0, longitude=128.0, tag='#exam')
        ...
        plane2 = Plane.objects.create(author=author1, content='I am tired', is_replied=False, is_reported=False,
                                      latitude=37.0, longitude=128.0, tag='#love')
        plane2.set_expiration_date()
        plane3 = Plane.objects.create(author=author2, content='I broke up yesterday', is_replied=False,
                                      is_reported=False, tag='#study')
    ...
    def test_write_plane(self):
        ...
        response = self.client.post('/api/plane', json.dumps({'content': 'I hate him', 'tag': '#love',
